...
description: "Automates the entire software release process including version bumping, changelog generation, and distribution"
target: "claude-code"
...
claudeCode:
  ...
  arguments:
    ...
    examples: ["--type minor", "--version 2.0.0", "--prerelease beta", "--dry-run", "--publish"]
  fileReferences:
    supports: true
    autoInclude: ["CLAUDE.md", "package.json", "Cargo.toml", "go.mod", "pom.xml", "CHANGELOG.md", ".releaserc.yml"]
  bashCommands:
    supports: true
    commands: ["git", "gh", "npm", "cargo", "docker", "go", "mvn", "gradle"]
  mcpIntegration:
    requiredServers: []
    optionalServers: ["github", "docker-registry", "package-manager"]
...
examples:
  - usage: "/release --type minor"
    description: "Create minor release with automatic version bumping and changelog generation"
    context: "Releasing new features with backwards compatibility"
    expectedOutcome: "Version updated, changelog generated, git tags created, GitHub release published"
  - usage: "/release --prerelease beta"
    ...
    expectedOutcome: "Beta version tagged, prerelease artifacts built, testing documentation provided"
...
# === Installation ===
installation:
  dependencies: ["git", "gh", "language-specific build tools"]
  setupSteps:
