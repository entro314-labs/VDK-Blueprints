...
description: "Generate comprehensive CI/CD pipelines for GitHub Actions, GitLab CI, and CircleCI with security and deployment automation"
target: "claude-code"
...
claudeCode:
  ...
  arguments:
    ...
    examples: ["--platform github", "--template advanced", "--security", "--update"]
  fileReferences:
    supports: true
    autoInclude: ["CLAUDE.md", "package.json", "go.mod", "Cargo.toml", "Dockerfile"]
  bashCommands:
    supports: true
    commands: ["git", "find", "grep"]
  mcpIntegration:
    requiredServers: []
    optionalServers: ["github", "gitlab"]
...
examples:
  - usage: "/ci-gen --template advanced"
    description: "Generate comprehensive CI/CD pipeline with matrix testing, security scanning, and deployment"
  ...
  - usage: "/ci-gen --platform gitlab --security"
    description: "Create GitLab CI pipeline with enhanced security scanning and compliance checks"
    context: "Migrating from GitHub Actions to GitLab CI with security focus"
    expectedOutcome: "GitLab CI configuration with SAST, dependency scanning, and vulnerability assessment"
  - usage: "/ci-gen --update"
    description: "Update existing CI configuration with latest best practices and security improvements"
    context: "Modernizing legacy CI pipeline with current standards"
    expectedOutcome: "Updated pipeline configuration with improved caching, security, and performance"
...
# === Metadata ===
category: "workflow"
tags: ["ci-cd", "github-actions", "gitlab-ci", "automation", "testing"]
author: "VDK"
