...
claudeCode:
  ...
  arguments:
    ...
    examples: ["--aspect naming", "--aspect structure", "--aspect all", "--scope src/", "--fix"]
  fileReferences:
    supports: true
    autoInclude: ["CLAUDE.md", "src/", "tests/", "package.json", "deno.json", ".eslintrc", ".editorconfig"]
  bashCommands:
    supports: true
    commands: ["deno", "go", "cargo", "rg", "fd", "mv", "mkdir"]
  mcpIntegration:
    requiredServers: []
    optionalServers: ["formatter", "linter", "code-analyzer"]
...
examples:
  - usage: "/standardize --aspect naming"
    description: "Standardize naming conventions for files, variables, functions, and database elements"
    context: "Cleaning up inconsistent naming across legacy codebase"
    expectedOutcome: "Consistent naming following camelCase, PascalCase, and snake_case conventions with updated imports"
  - usage: "/standardize --aspect structure"
    description: "Reorganize project structure following standard conventions and best practices"
    context: "Refactoring project layout for better maintainability and team onboarding"
    expectedOutcome: "Standard directory structure with properly organized components, services, and utilities"
  - usage: "/standardize --aspect all"
    description: "Comprehensive standardization including naming, structure, patterns, and documentation"
    context: "Major codebase cleanup before team expansion or major feature development"
    expectedOutcome: "Fully standardized codebase with consistent patterns, error handling, and documentation"

# === Installation ===
installation:
  dependencies: ["formatters", "linters", "code analysis tools"]
  setupSteps:
