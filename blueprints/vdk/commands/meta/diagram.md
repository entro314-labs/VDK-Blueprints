...
claudeCode:
  ...
  arguments:
    ...
    examples: ["architecture", "flow", "sequence", "class", "entity", "--type mermaid", "--scope frontend"]
  fileReferences:
    supports: true
    autoInclude: ["CLAUDE.md", "package.json", "src/", "docs/", "README.md"]
  bashCommands:
    supports: true
    commands: ["find", "grep", "deno", "node"]
  mcpIntegration:
    requiredServers: []
    optionalServers: ["mermaid", "diagram-generator"]
...
examples:
  - usage: "/diagram architecture"
    description: "Generate comprehensive architecture diagram showing system components and relationships"
    context: "Creating documentation for new team members or architecture review"
    expectedOutcome: "ASCII/Mermaid diagram with frontend, backend, database layers and component interactions"
  - usage: "/diagram sequence --scope auth"
    ...
    expectedOutcome: "Detailed sequence diagram showing login, token generation, and validation steps"
...
# === Installation ===
installation:
  dependencies: ["deno", "mermaid-cli (optional)"]
  setupSteps:
